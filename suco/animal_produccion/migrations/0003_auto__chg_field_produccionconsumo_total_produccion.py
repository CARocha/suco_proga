...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProduccionConsumo.total_produccion'
        db.alter_column('animal_produccion_produccionconsumo', 'total_produccion', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'ProduccionConsumo.total_produccion'
        db.alter_column('animal_produccion_produccionconsumo', 'total_produccion', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'animal_produccion.produccionconsumo': {
            ...
            'total_produccion': ('django.db.models.fields.FloatField', [], {}),
