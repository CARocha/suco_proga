...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CultivosPatio.area'
        db.alter_column('cultivos_cultivospatio', 'area', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'CultivosPatio.area'
        db.alter_column('cultivos_cultivospatio', 'area', self.gf('django.db.models.fields.FloatField')())
