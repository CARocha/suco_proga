...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CultivosPatio'
        db.create_table('cultivos_cultivospatio', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cultivo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cultivos.Patio'])),
            ...
            ('venta_organizada', self.gf('django.db.models.fields.IntegerField')()),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['encuesta.Encuesta'])),
        ))
        db.send_create_signal('cultivos', ['CultivosPatio'])

        # Adding M2M table for field venta_libre on 'CultivosPatio'
        db.create_table('cultivos_cultivospatio_venta_libre', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cultivospatio', models.ForeignKey(orm['cultivos.cultivospatio'], null=False)),
            ('aquienvende', models.ForeignKey(orm['animal_produccion.aquienvende'], null=False))
        ))
        db.create_unique('cultivos_cultivospatio_venta_libre', ['cultivospatio_id', 'aquienvende_id'])

        # Adding model 'Patio'
        db.create_table('cultivos_patio', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('cultivos', ['Patio'])

        # Adding model 'division'
        db.create_table('cultivos_division', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cuanto', self.gf('django.db.models.fields.FloatField')()),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['encuesta.Encuesta'])),
        ))
        db.send_create_signal('cultivos', ['division'])

        # Changing field 'Cultivos.venta_organizada'
        db.alter_column('cultivos_cultivos', 'venta_organizada', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Deleting model 'CultivosPatio'
        db.delete_table('cultivos_cultivospatio')

        # Removing M2M table for field venta_libre on 'CultivosPatio'
        db.delete_table('cultivos_cultivospatio_venta_libre')

        # Deleting model 'Patio'
        db.delete_table('cultivos_patio')

        # Deleting model 'division'
        db.delete_table('cultivos_division')

        # Changing field 'Cultivos.venta_organizada'
        db.alter_column('cultivos_cultivos', 'venta_organizada', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        'cultivos.cultivos': {
            ...
            'venta_organizada': ('django.db.models.fields.IntegerField', [], {})
        },
        'cultivos.cultivospatio': {
            'Meta': {'object_name': 'CultivosPatio'},
            'area': ('django.db.models.fields.FloatField', [], {}),
            'consumo': ('django.db.models.fields.FloatField', [], {}),
            'cultivo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cultivos.Patio']"}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['encuesta.Encuesta']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'precio': ('django.db.models.fields.FloatField', [], {}),
            'total': ('django.db.models.fields.FloatField', [], {}),
