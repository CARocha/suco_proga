...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TipoCultivos.utilizar_en_kg_por_hectare'
        db.add_column('cultivos_tipocultivos', 'utilizar_en_kg_por_hectare',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TipoCultivos.utilizar_en_kg_por_hectare'
        db.delete_column('cultivos_tipocultivos', 'utilizar_en_kg_por_hectare')
    ...
    models = {
        ...
        'cultivos.cultivospatio': {
            ...
            'area': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'consumo': ('django.db.models.fields.FloatField', [], {}),
        ...
        'cultivos.patio': {
            'Meta': {'ordering': "('nombre',)", 'object_name': 'Patio'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'cultivos.tipocultivos': {
            'Meta': {'ordering': "('nombre',)", 'object_name': 'TipoCultivos'},
            'conversion_kg': ('django.db.models.fields.FloatField', [], {'default': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            ...
            'utilizar_en_kg_por_hectare': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        'encuesta.encuesta': {
            ...
            'edad': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            ...
            'sexo': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
